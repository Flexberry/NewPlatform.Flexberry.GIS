...
'</div>');
            ...
            switch (type) {
                case 'alert':
                    ...
                    /*
                     * Анисимова, 01.02.2016: В оригинале была подписка на событие "keypress", а не "keydown".
                     * В Chrome нажатие "esc" (код 27) по "keypress" не отлавливается, поэтому использовалось "keydown".
                     */
